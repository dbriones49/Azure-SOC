...
![image](https://github.com/dbriones49/Azure-SOC/assets/143753667/8ac18f66-3771-4a23-97df-c57518dac1af)
...
Building a honeynet on Azure was a valuable learning experience that provided insight into the flow of resources and activity logs within the cloud environment. I gained a deeper understanding of how different components interact and how important it is to monitor and analyze activity logs for potential security threats. The integration of Azure Active Directory was crucial in ensuring secure access control and authentication for the honeynet. Additionally, the project highlighted the importance of ensuring that all logs are correctly flowing to the Log Analytic workspace for centralized monitoring and analysis. Testing the logging functionality was essential to verify that all relevant information was being captured and analyzed effectively to enhance the overall security posture of the honeynet..
